...
def model_fine(timesteps, domin, optimizer_chose, epochs,nums_save):
    ...
    lstm = SimpleRNN(32, return_sequences=False)  # , kernel_initializer='Orthogonal', bias_initializer='zeros'
    ...
    for i in range(epochs):
        ...
        if i % 20 == 0 :
            ...
            with open('result_RNN/TimeCost_'+str(nums_save)+'.txt', 'a') as f:
            ...
            write_mat(forecasttestY2,'result_RNN/data/', str(nums_save)+'_'+str(i)+'forecasttestY2')
            write_mat(actualtestY2,'result_RNN/data/', 'actualtestY2_'+str(nums_save))
            ...
            write_mat(forecasttestfh,'result_RNN/data/', str(nums_save)+'_'+str(i)+'forecasttestfh')
            write_mat(actualtestfh,'result_RNN/data/', 'actualtestfh'+str(nums_save))


            with open('result_RNN/result_'+str(nums_save)+'.txt', 'a') as f:
            ...
            pyplot.legend()
            pyplot.savefig("result_RNN/result_"+str(nums_save)+"/number_"+str(i)+".png")
            pyplot.close()
